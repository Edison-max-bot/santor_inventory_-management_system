...
<div class="wrapper">
  ...
  <!--     ikkaten    <li class="nav-item menu-open">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="pages/tables/request.php" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="pages/tables/requesteditem.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Requested Items</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="pages  /Actions/logout.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Logout</p>
                </a>
              </li>
