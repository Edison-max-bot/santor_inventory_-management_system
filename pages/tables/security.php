              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <?php
                      $q = mysqli_query($con,"SELECT * FROM security WHERE acc='User'");
...
<script>
  $(document).ready(function(){
        ...
        $("#save").click(function(e){
          ...
          $.ajax({
            url: '../Actions/Security/AddSecurity.php',
            type: 'POST',
            data : formData,
          ...
          if(confirm('Are you sure you want to delete this data?'))
            {
               $.ajax({
                    type: "POST",
                    url: '../Actions/Security/delSecurity.php',
                    data: {
                        'cid': cid
                    },
                    success: function (response) {
        ...
        $(".edit").click(function(e){
            ...
            $.ajax({
                    type: "POST",
                    url: '../Actions/Security/fetchSecurity.php',
                    data: {
                        'cid': cid
                    },
                    dataType: 'json',
                    success: function (response) {
                         ...
                         $("#fullname").val(response.acc);
                        // $("#username").enabled=false;
                         $("#p_id").val(response.user);
