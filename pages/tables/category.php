            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
                    $q = mysqli_query($con,"SELECT * FROM Category order by categorydesc desc");
...
<script>
  $(document).ready(function(){
          ...
          if(confirm('Are you sure you want to delete this data?'))
            {
               $.ajax({
                    type: "POST",
                    url: '../Actions/Category/delCat.php',
                    data: {
                        'cid': cid
                    },
                    success: function (response) {
        ...
        $(".edit").click(function(e){
            ...
            $.ajax({
                    type: "POST",
                    url: '../Actions/Category/fetch.php',
                    data: {
                        'cid': cid
                    },
                    dataType: 'json',
                    success: function (response) {
                        ...
                        $("#cat").val(response.categoryDesc);
                        $("#p_id").val(response.cid);
