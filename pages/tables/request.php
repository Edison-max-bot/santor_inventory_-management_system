            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
                    $q = mysqli_query($con,"SELECT * FROM vtemprequest");
...
<script>
  $(document).ready(function(){
      ...
      $("#code").val("RequestNo-" + randomNumber);
     
      $("#stockin").click(function(){
        $.ajax({
           type: "POST",
           url: "../Actions/Request/delete.php",
      ...
      $("#add").click(function(e){
        ...
        $("#save").click(function(e){
          ...
          $.ajax({
            url: '../Actions/Request/AddTempItem.php',
            type: 'POST',
            data : formData,
        ...
        $(".delete").click(function(e){
          ...
          if(confirm('Are you sure you want to delete this data?'))
            {
               $.ajax({
                    type: "POST",
                    url: '../Actions/Request/delItem.php',
                    data: {
                        'cid': cid
                    },
                    success: function (response) {
         ...
         $(".select").click(function(e){
          ...
          var cid=$(this).val();
               ...
               $.ajax({
                    type: "POST",
                    url: '../Actions/Request/selItem.php',
                    data: {
                        'cid': cid
                    },
                    dataType:'json',
        ...
        $(".increase").click(function(e){
          ...
          var cid=$(this).val();
               $.ajax({
                    type: "POST",
                    url: '../Actions/Request/increase.php',
                    data: {
                        'cid': cid
                    },
                    success: function (response) {
        ...
        $(".decrease").click(function(e){
          e.preventDefault();
           ...
           var cid=$(this).val();
               $.ajax({
                    type: "POST",
                    url: '../Actions/Request/decrease.php',
                    data: {
                        'cid': cid
                    },
                    success: function (response) {
        ...
        $("#saveall").click(function(e){
          e.preventDefault();
              ...
              var formStock = $("#Stock").serialize();
               $.ajax({
                    type: "POST",
                    url: '../Actions/Request/stocks.php',
                    data: formStock,
                    success: function (response) {
                      //alert(response);
