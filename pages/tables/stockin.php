...
$sql = "SELECT fullname FROM suppliers";
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
                    $q = mysqli_query($con,"SELECT * FROM vtempstockin");
                  ...
                  ?>
                    ...
                    <td>
                        <button class="btn btn-danger decrease" value="<?php echo $rows[0]; ?>" >Decrease</button>
                        <button class="btn btn-primary increase" value="<?php echo $rows[0]; ?>" >Increase</button>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="container"> 
                  ...
                  <tbody>
                    <?php
                    $q = mysqli_query($con,"SELECT  * from vitems LIMIT 3");
                    while ($rows=mysqli_fetch_array($q)) {
                  ?>
                    <tr>  
                        <td><?php echo  $rows[1]; ?></td>
...
<script>
  $(document).ready(function(){
     ...
     $("#supplier").keyup(function() {
           $.ajax({
           type: "POST",
           url: "../Actions/ajax-supplier-search.php",
      ...
      $("#add").click(function(e){
        ...
        $("#save").click(function(e){
          ...
          $.ajax({
            url: '../Actions/TempStockIn/AddTempItem.php',
            type: 'POST',
            data : formData,
        ...
        $(".delete").click(function(e){
          ...
          if(confirm('Are you sure you want to delete this data?'))
            {
               $.ajax({
                    type: "POST",
                    url: '../Actions/TempStockIn/delItem.php',
                    data: {
                        'cid': cid
                    },
                    success: function (response) {
         ...
         $(".select").click(function(e){
          ...
          var cid=$(this).val();
               ...
               $.ajax({
                    type: "POST",
                    url: '../Actions/TempStockIn/selItem.php',
                    data: {
                        'cid': cid
                    },
                    dataType:'json',
        ...
        $(".increase").click(function(e){
          ...
          var cid=$(this).val();
               $.ajax({
                    type: "POST",
                    url: '../Actions/TempStockIn/increase.php',
                    data: {
                        'cid': cid
                    },
                    success: function (response) {
        ...
        $(".decrease").click(function(e){
          e.preventDefault();
           ...
           var cid=$(this).val();
               $.ajax({
                    type: "POST",
                    url: '../Actions/TempStockIn/decrease.php',
                    data: {
                        'cid': cid
                    },
                    success: function (response) {
        ...
        $("#saveall").click(function(e){
          e.preventDefault();
              ...
              var formStock = $("#Stock").serialize();
               $.ajax({
                    type: "POST",
                    url: '../Actions/TempStockIn/stocks.php',
                    data: formStock,
                    success: function (response) {
