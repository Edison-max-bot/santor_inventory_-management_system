            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
                    $q = mysqli_query($con,"SELECT * FROM suppliers order by Fullname desc");
...
<script>
  $(document).ready(function(){
        ...
        $("#save").click(function(e){
          ...
          $.ajax({
            url: '../Actions/Suppliers/AddSuppliers.php',
            type: 'POST',
            data : formData,
          ...
          if(confirm('Are you sure you want to delete this data?'))
            {
               $.ajax({
                    type: "POST",
                    url: '../Actions/Suppliers/delSuppliers.php',
                    data: {
                        'cid': cid
                    },
                    success: function (response) {
        ...
        $(".edit").click(function(e){
            ...
            $.ajax({
                    type: "POST",
                    url: '../Actions/Suppliers/fetchSuppliers.php',
                    data: {
                        'cid': cid
                    },
                    dataType: 'json',
