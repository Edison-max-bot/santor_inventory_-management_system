  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>List of Requested Items From User</h1>
          </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
                    $q = mysqli_query($con,"SELECT * FROM vrequest");
                  ...
                  ?>
                    ...
                    <td><?php if ($rows[6]=='0'){?> <button class="btn btn-danger">Pending</button> <?php } else {?>  <button class="btn btn-primary">Approved</button> <?php } ?></td>
                    <td><?php echo $rows[7]; ?></td>
                    <td>
                        <button class="btn btn-success delete" value="<?php echo $rows[1]; ?>" >Approve</button>
                    </td>
                    </tr>
                    <?php
                      }
